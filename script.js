...
//             alarm.textContent = todo.alarm ? ` | 알람: ${new Date(todo.alarm).toLocaleString()}` : '';
...
//     <input type="text" value="${todo.tags.join(' ')}" id="editTag">
...
//     setInterval(checkAlarms, 1000); // 알람을 1초 간격으로 확인
